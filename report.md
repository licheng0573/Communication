...
![trans jiemian](pic/trans%20jiemian.png)
...
1. **词汇/术语/例句参考区**
   ...
   1. **译文编辑区**
      ...
      ![切换跟随模式](pic/切换跟随模式.png)

      ![退出跟随模式](pic/退出跟随模式.png)

      2）跟踪用户输入、实时更新推荐译文
      3）选中推荐译文任意片段，直接插入编辑框

      ![推荐直接插入](pic/推荐直接插入.png)
...
![transmart term](pic/transmart%20term.png)
...
![](pic\translate5manager.png)

![](pic\translate5proofhead.png)
